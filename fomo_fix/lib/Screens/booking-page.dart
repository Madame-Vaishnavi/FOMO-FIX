...
class _BookingPageState extends State<BookingPage> {
  ...
  Future<void> _fetchEventDetails() async {
    try {
      ...
      final response = await ApiService.getWithAuth('/events/${widget.event.id}',token!);
  ...
  Future<void> _handleBooking() async {
    ...
    for (var bookingEntry in bookingsToMake) {
      try {
        ...
        final response = await ApiService.postWithAuth(token!,'/bookings', bookingBody);
        print(response.body);
        print(bookingBody);
    ...
    if (failedBookings.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Some bookings failed: ${failedBookings.join(', ')}. Please try again.'),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      _buildDetailRow(Icons.category_outlined, event.categoryDisplayName),
                      const SizedBox(height: 20),
                      const Text(
                        'About this event',
                        style: TextStyle(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _isBooking || _detailedEvent == null ? null : _handleBooking,
