...
public class EventRequestDTO {
    ...
    public EventRequestDTO(String name, String description, String location, LocalDateTime date,EventCategory category, List<SeatCategoryDTO> seatCategories, String imageUrl) {
        this.name = name;
